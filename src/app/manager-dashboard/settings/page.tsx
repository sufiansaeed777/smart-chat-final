...
const SettingsPage = () => {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      {/* Tabs Navigation */}
      <div className="border-b border-gray-200 bg-white rounded-t-2xl px-6">
      ...
      {/* Profile Tab Content */}
      {activeTab === 'profile' && (
        <Card className="border border-gray-200 bg-white rounded-b-2xl">
          <CardHeader>
