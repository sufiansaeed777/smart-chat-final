...
const HelpPage = () => {
  ...
  const tabsWithCounts = contentTabs.map(tab => ({
    ...tab,
    count: tab.id === 'articles' ? articles.length :
  ...
  const handleArticleClick = (articleId: string) => {
    router.push(`/user-dashboard/help/article/${articleId}`);
  };
            ...
            <div className="space-y-4">
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">No video tutorials available in this category yet.</p>
                </div>
              ) : (
            ...
            <div className="space-y-3">
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">No FAQs available in this category yet.</p>
                </div>
              ) : (
                <div className="space-y-3">
